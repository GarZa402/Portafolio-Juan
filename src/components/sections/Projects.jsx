...
const projects = [
  {
    ...
    icon: Code,
    githubUrl: "https://github.com/GarZa402/SalleConnect",
  },
  {
    title: "Attendo",
    ...
    icon: Briefcase,
    githubUrl: "https://github.com/GarZa402/Attendo",
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => {
              ...
              return (
                <article
                  key={index}
                  className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-blue-500 transition-all group"
                >
